...
- [Single-Cycle CPU Implementation](#single-cycle-cpu-implementation)
  ...
  - [F1 Finite State Machine Testing](#f1-finite-state-machine-testing)
...
[Program Counter Module](../rtl/pc.sv) | [Top Level Module](../rtl/top.sv) | [Supporting Components](../rtl/)

In the Single-Cycle CPU, I was mainly in charge of implementing all of the top level components, creating the Program Counter (PC), and putting it all together in an intuitive way in the top layer splitting the modules into fetch, decode, and execute.
...
[ALU Top Module](../rtl/execute/ALU_top.sv) | [Hazard Unit](../rtl/hazard_unit.sv) | [Division Module](../rtl/execute/div_mc.sv) | [Branch:    Pipeline-MUL-DIV](https://github.com/SAMOS-76/RISC-V-Team7/tree/Pipeline-MUL-DIV) | [Branch:  Pipeline-MUL-final](https://github.com/SAMOS-76/RISC-V-Team7/tree/Pipeline-MUL-final)
